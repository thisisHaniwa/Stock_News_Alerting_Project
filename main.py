...
STOCK_NAME = "TSLA" #input("Which stock are you interested in, as defined by the stock market?")
#COMPANY_NAME will be passed in the NEWS API to retrieve articles related to the company name
COMPANY_NAME = "Tesla Inc"   #input("What is the name of the company of that stock?)
...
if percentage < 5:
    ...
    phone_number = input("Enter the phone number you wish to receive the SMSes from: ")
